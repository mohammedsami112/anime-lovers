<template>
  <div class="like-anime">
    <v-container>
      <div class="section-header mb-4 d-flex justify-space-between align-center flex-sm-row flex-column">
        <h4 class="section-title w-sm-100">الاكثر اعجابا</h4>
        <!-- <NuxtLink to="/anime">
              <v-btn variant="tonal" color="primary"> جميع الانميات </v-btn>
            </NuxtLink> -->
      </div>
      <v-row>
        <v-col class="mt-3" cols="12" lg="3" md="4" sm="6" v-for="anime in homeStore.most_likes" :key="anime.id">
