...
const _routes = [
  {
    name: "anime-id-slug-id-slug",
    path: "/anime/:id()-:slug()/:id()-:slug()",
    meta: {},
    alias: [],
    redirect: void 0,
  ...
  },
  {
    ...
    path: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.path) ?? "/category/:id()-:title()",
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "menu-box" }, _attrs))} data-v-cfe42836><div class="menu-icon" data-v-cfe42836>`);
      _push(ssrRenderComponent(_component_font_awesome_icon, { icon: "fa-solid fa-bars" }, null, _parent));
      _push(`</div><div class="box" data-v-cfe42836>`);
      _push(ssrRenderComponent(_component_v_layout, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_v_navigation_drawer, {
              location: "left",
              modelValue: menuBoxStatus.value,
              "onUpdate:modelValue": ($event) => menuBoxStatus.value = $event,
              temporary: ""
            }, {
                  ...
                  _push3(ssrRenderComponent(_component_v_list, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<!--[-->`);
                        ssrRenderList(unref(store).categories, (category) => {
                        ...
                        return [
                          ...
                          unref(store).categories.length > 0 ? (openBlock(), createBlock(_component_v_list_subheader, { key: 0 }, {
                            default: withCtx(() => [
                              createTextVNode("الاقسام")
                            ]),
                            _: 1
                          })) : createCommentVNode("", true),
                          (openBlock(true), createBlock(Fragment, null, renderList(unref(store).categories, (category) => {
      ...
      _push(ssrRenderComponent(_component_v_expand_transition, { mode: "out-in" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    return [
                      createVNode("div", {
                        class: "close-box",
                        onClick: ($event) => searchBoxStatus.value = false
                      }, [
            ...
            return [
              searchBoxStatus.value ? (openBlock(), createBlock("div", {
                key: 0,
                class: "box"
              }, [
                createVNode(_component_v_container, { class: "d-flex align-center justify-center w-100 h-100" }, {
                  default: withCtx(() => [
                    createVNode("div", {
                      class: "close-box",
                      onClick: ($event) => searchBoxStatus.value = false
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_v_container, { class: "d-flex justify-space-between align-center" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="left-icons" data-v-67cadbd1${_scopeId}>`);
            _push2(ssrRenderComponent(headerSearch, null, null, _parent2, _scopeId));
            _push2(`</div><div class="logo" data-v-67cadbd1${_scopeId}><h2 data-v-67cadbd1${_scopeId}>Anime Lovers</h2></div><div class="right-icons" data-v-67cadbd1${_scopeId}>`);
            _push2(ssrRenderComponent(_component_headerMenu, null, null, _parent2, _scopeId));
            _push2(`</div>`);
          } else {
            return [
              createVNode("div", { class: "left-icons" }, [
                createVNode(headerSearch)
              ]),
              createVNode("div", { class: "logo" }, [
                createVNode("h2", null, "Anime Lovers")
              ]),
              createVNode("div", { class: "right-icons" }, [
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<footer${ssrRenderAttrs(mergeProps({ class: "d-flex justify-center align-center" }, _attrs))} data-v-4ee45b89><h4 data-v-4ee45b89>جميع الحقوق محفوظة لموقع Anime Lovers</h4></footer>`);
}
